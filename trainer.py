...
def train(model, args):
    ...
    # Save plot to a file
    plt.tight_layout()
    plt.savefig("2numfflayer"+"num_layers"+str(args.num_layers)+'training_plots.png')

    # Save data to a file
    with open("2numfflayer"+"num_layers"+str(args.num_layers)+'training_data.txt', 'w') as file:
